...
/*
  TODO:
     if your system does not support newsletter please remove this
     if your system does not support or require RECAPTCHA remove it
     replace VITE_APP_API_URL and other related environment with
      ...
      <div className="bg-primary m-2 m-md-5 shadow">
        <CRow className="h-100 justify-content-start align-items-center p-5">
          <CCol xs={12} md={7} lg={6} xl={5} className="mb-4 p-2" data-aos="zoom-in-down">
            ...
            <p className="lead text-white">We will email you about our products newest updates.</p>
