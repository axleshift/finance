...
const create = asyncHandler(async (req, res) => {
  ...
  const created = new depositModel({
...
const depositAggregate = asyncHandler(async (req, res) => {
  const total = await depositModel.aggregate([
    {
      $group: {
        _id: null,
...
export { create, getAllDeposit, depositAggregate };
